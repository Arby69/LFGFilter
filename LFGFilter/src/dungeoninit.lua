...
function LFGFilter:DefineBCCDungeons()
	...
	self:DefineBCDungeon("Shattered Halls", "Hellfire Peninsula", 69, 69, 70, 70, { "shh", "shatt%a*halls?", "shatt%a*d", "halls" }, { "seth%a*", "light%a*" })
...
function LFGFilter:DefineWotLKDungeons()
	...
	self:DefineWotlkDungeon("Utgarde Keep", "Howling Fjord", 68, 70, 72, 75, { "uk", "u.*keep", "utgar[de]*%W[kep]+" }, { "shadow%a" }, { {477,1}, {17213,2}, {489,2}, {1919,2} })
	self:DefineWotlkDungeon("The Nexus", "Borean Tundra", 70, 71, 73, 75, { "nex", "nexus", "nex%a*" })
	self:DefineWotlkDungeon("Azjol-Nerub", "Dragonblight", 70, 72, 75, 77, { "azj", "azjo?l", "nerub" })
	self:DefineWotlkDungeon("Ahn'kahet: The Old Kingdom", "Dragonblight", 71, 73, 76, 78, { "ahnk", "ah%a*.?kah%a*", "old%Wkingd%a*", "ah?nkah?et" })
	self:DefineWotlkDungeon("Drak'Tharon Keep", "Grizzly Hills", 72, 74, 76, 78, { "dt", "%a*k%W*tharon", "drak%W*th%a*" })
	self:DefineWotlkDungeon("Violet Hold", "Dalaran", 73, 75, 77, 79, { "vh", "vio%a*", "v%a*%W*hold" })
	self:DefineWotlkDungeon("Halls of Stone", "The Storm Peaks", 75, 77, 79, 80, { "hos", "hall%a*stone" })
	self:DefineWotlkDungeon("Gundrak", "", 76, 77, 79, 80, { "gd", "g%a*drak", "gun%Wdrak" })
	self:DefineWotlkDungeon("Utgarde Pinnacle", "Howling Fjord", 78, 79, 80, 80, { "up", "pin+ac[le]*", "ymiron", "utgar[de]*%Wpin+[acle]*" })
	self:DefineWotlkDungeon("Halls of Lightning", "The Storm Peaks", 78, 79, 80, 80, { "hol", "lightn[ing]*", "loken" })
	self:DefineWotlkDungeon("Oculus", "Borean Tundra", 78, 79, 80, 80, { "oculus", "oc+o?[lus]*" })
	self:DefineWotlkDungeon("Culling of Stratholme", "Tanaris", 78, 79, 80, 80, { "cos", "culling", "cot.*4", "strat", "strath%a*", "starth%a*", "straht%a*", "%a*ganis" })
	...
	self:DefineWotlkRaid("Obsidian Sanctum", "Dragonblight", { "obsi", "os", "sanctum", "obsi%dd?", "obsi.%d", "sar?t[harion]*" }, { "ms" })
