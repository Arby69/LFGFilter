...
function LFGFilter:DefineBCCDungeons()
	...
	self:DefineHeroDungeon("Hellfire Ramparts", 5, "Hellfire Peninsula", LFGFilter.Factions.BOTH, 59, 60, 62, 70, 70, { "hr", "ramp.*s" })
	...
	self:DefineHeroDungeon("Sethekk Halls", 5, "Auchindoun", LFGFilter.Factions.BOTH, 66, 67, 69, 70, 70, { "sh", "sethek%a*", "s%a*halls?" })
	...
	self:DefineHeroDungeon("Shattered Halls", 5, "Hellfire Peninsula", LFGFilter.Factions.BOTH, 68, 69, 70, 70, 70, { "sh", "shatt%a*halls?", "shatt%a*d" })
